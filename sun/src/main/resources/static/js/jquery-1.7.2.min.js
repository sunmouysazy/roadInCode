...
(function(a, b) {
  ...
  function bk(a, b) {
    var c;
    b.nodeType === 1 && (b.clearAttributes && b.clearAttributes(), b.mergeAttributes && b.mergeAttributes(a), c = b.nodeName.toLowerCase(), c === 'object' ? b.outerHTML = a.outerHTML : c !== 'input' || a.type !== 'checkbox' && a.type !== 'radio' ? c === 'option'
        ? b.selected = a.defaultSelected
        : c === 'input' || c === 'textarea' ? b.defaultValue = a.defaultValue : c === 'script' && b.text !== a.text && (b.text = a.text) : (a.checked && (b.defaultChecked = b.checked = a.checked), b.value !== a.value && (b.value = a.value)), b.removeAttribute(
  ...
  var c = a.document, d = a.navigator, e = a.location, f = function() {
    ...
    var e = function(a, b) {return new e.fn.init(a, b, h);}, f = a.jQuery, g = a.$, h, i = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, j = /\S/, k = /^\s+/, l = /\s+$/, m = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, n = /^[\],:{}\s]*$/, o = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,
    ...
    e.fn = e.prototype = {
      ...
      init: function(a, d, f) {
        ...
        if (typeof a == 'string') {
          ...
          if (g && (g[1] || !d)) {
            if (g[1]) {
              d = d instanceof e ? d[0] : d, k = d ? d.ownerDocument || d : c, j = m.exec(a), j ? e.isPlainObject(d) ? (a = [c.createElement(j[1])], e.fn.attr.call(a, d, !0)) : a = [k.createElement(j[1])] : (j = e.buildFragment([g[1]], [k]), a = (j.cacheable
                  ? e.clone(j.fragment)
      ...
      browser: {},
    }), e.each('Boolean Number String Function Array Date RegExp Object'.split(' '), function(a, b) {I['[object ' + b + ']'] = b.toLowerCase();}), z = e.uaMatch(y), z.browser && (e.browser[z.browser] = !0, e.browser.version = z.version), e.browser.webkit &&
    (e.browser.safari = !0), j.test(' ') && (k = /^[\s\xA0]+/, l = /[\s\xA0]+$/), h = e(c), c.addEventListener ? B = function() {c.removeEventListener('DOMContentLoaded', B, !1), e.ready();} : c.attachEvent &&
        (B = function() {c.readyState === 'complete' && (c.detachEvent('onreadystatechange', B), e.ready());});
    return e;
  }(), g = {};
  ...
  f.extend({
    Deferred: function(a) {
      var b = f.Callbacks('once memory'), c = f.Callbacks('once memory'), d = f.Callbacks('memory'), e = 'pending', g = {resolve: b, reject: c, notify: d}, h = {
        done: b.add, fail: c.add, progress: d.add, state: function() {return e;}, isResolved: b.fired, isRejected: c.fired, then: function(a, b, c) {
    ...
    !p.addEventListener && p.attachEvent && p.fireEvent && (p.attachEvent('onclick', function() {b.noCloneEvent = !1;}), p.cloneNode(!0).fireEvent('onclick')), i = c.createElement('input'), i.value = 't', i.setAttribute('type', 'radio'), b.radioValue = i.value ===
        't', i.setAttribute('checked', 'checked'), i.setAttribute('name', 't'), p.appendChild(i), j = c.createDocumentFragment(), j.appendChild(p.lastChild), b.checkClone = j.cloneNode(!0).cloneNode(!0).lastChild.checked, b.appendChecked = i.checked, j.removeChild(
        i), j.appendChild(p);
    if (p.attachEvent) for (n in{submit: 1, change: 1, focusin: 1}) m = 'on' + n, o = m in p, o || (p.setAttribute(m, 'return;'), o = typeof p[m] == 'function'), b[n + 'Bubbles'] = o;
    j.removeChild(p), j = g = h = p = i = null, f(function() {
      var d, e, g, h, i, j, l, m, n, q, r, s, t, u = c.getElementsByTagName('body')[0];
      !u || (m = 1, t = 'padding:0;margin:0;border:', r = 'position:absolute;top:0;left:0;width:1px;height:1px;', s = t + '0;visibility:hidden;', n = 'style=\'' + r + t + '5px solid #000;', q = '<div ' + n + 'display:block;\'><div style=\'' + t +
          '0;display:block;overflow:hidden;\'></div></div>' + '<table ' + n + '\' cellpadding=\'0\' cellspacing=\'0\'>' + '<tr><td></td></tr></table>', d = c.createElement('div'), d.style.cssText = s + 'width:0;height:0;position:static;top:0;margin-top:' + m +
          'px', u.insertBefore(d,
          u.firstChild), p = c.createElement('div'), d.appendChild(p), p.innerHTML = '<table><tr><td style=\'' + t + '0;display:none\'></td><td>t</td></tr></table>', k = p.getElementsByTagName('td'), o = k[0].offsetHeight ===
          0, k[0].style.display = '', k[1].style.display = 'none', b.reliableHiddenOffsets = o && k[0].offsetHeight === 0, a.getComputedStyle &&
      (p.innerHTML = '', l = c.createElement('div'), l.style.width = '0', l.style.marginRight = '0', p.style.width = '2px', p.appendChild(l), b.reliableMarginRight = (parseInt((a.getComputedStyle(l, null) || {marginRight: 0}).marginRight, 10) || 0) === 0), typeof p.style.zoom !=
      'undefined' && (p.innerHTML = '', p.style.width = p.style.padding = '1px', p.style.border = 0, p.style.overflow = 'hidden', p.style.display = 'inline', p.style.zoom = 1, b.inlineBlockNeedsLayout = p.offsetWidth ===
          3, p.style.display = 'block', p.style.overflow = 'visible', p.innerHTML = '<div style=\'width:5px;\'></div>', b.shrinkWrapBlocks = p.offsetWidth !== 3), p.style.cssText = r +
          s, p.innerHTML = q, e = p.firstChild, g = e.firstChild, i = e.nextSibling.firstChild.firstChild, j = {
        doesNotAddBorder: g.offsetTop !== 5,
        doesAddBorderForTableAndCells: i.offsetTop === 5,
      }, g.style.position = 'fixed', g.style.top = '20px', j.fixedPosition = g.offsetTop === 20 || g.offsetTop === 15, g.style.position = g.style.top = '', e.style.overflow = 'hidden', e.style.position = 'relative', j.subtractsBorderForOverflowNotVisible = g.offsetTop ===
          -5, j.doesNotIncludeMarginInBodyOffset = u.offsetTop !== m, a.getComputedStyle && (p.style.marginTop = '1%', b.pixelMargin = (a.getComputedStyle(p, null) || {marginTop: 0}).marginTop !== '1%'), typeof d.style.zoom != 'undefined' && (d.style.zoom = 1), u.removeChild(
  ...
  })), f.support.enctype || (f.propFix.enctype = 'encoding'), f.support.checkOn || f.each(['radio', 'checkbox'], function() {f.valHooks[this] = {get: function(a) {return a.getAttribute('value') === null ? 'on' : a.value;}};}), f.each(['radio', 'checkbox'],
      function() {f.valHooks[this] = f.extend(f.valHooks[this], {set: function(a, b) {if (f.isArray(b)) return a.checked = f.inArray(f(a).val(), b) >= 0;}});});
  ...
  f.event = {
    add: function(a, c, d, e, g) {
      ...
      if (!(a.nodeType === 3 || a.nodeType === 8 || !c || !d || !(h = f._data(a)))) {
        d.handler && (p = d, d = p.handler, g = p.selector), d.guid || (d.guid = f.guid++), j = h.events, j || (h.events = j = {}), i = h.handle, i ||
        (h.handle = i = function(a) {return typeof f != 'undefined' && (!a || f.event.triggered !== a.type) ? f.event.dispatch.apply(i.elem, arguments) : b;}, i.elem = a), c = f.trim(I(c)).split(' ');
        for (k = 0; k < c.length; k++) {
          l = A.exec(c[k]) || [], m = l[1], n = (l[2] || '').split('.').sort(), s = f.event.special[m] || {}, m = (g ? s.delegateType : s.bindType) || m, s = f.event.special[m] || {}, o = f.extend(
              {type: m, origType: l[1], data: e, handler: d, guid: d.guid, selector: g, quick: g && G(g), namespace: n.join('.')}, p), r = j[m];
          if (!r) {
    ...
    trigger: function(c, d, e, g) {
      if (!e || e.nodeType !== 3 && e.nodeType !== 8) {
        ...
        c = typeof c == 'object' ? c[f.expando] ? c : new f.Event(h, c) : new f.Event(h), c.type = h, c.isTrigger = !0, c.exclusive = k, c.namespace = i.join('.'), c.namespace_re = c.namespace ? new RegExp('(^|\\.)' + i.join('\\.(?:.*\\.)?') + '(\\.|$)') : null, o = h.indexOf(
            ':') < 0 ? 'on' + h : '';
        if (!e) {
          j = f.cache;
        ...
        c.type = h, !g && !c.isDefaultPrevented() && (!p._default || p._default.apply(e.ownerDocument, d) === !1) && (h !== 'click' || !f.nodeName(e, 'a')) && f.acceptData(e) && o && e[h] && (h !== 'focus' && h !== 'blur' || c.target.offsetWidth !== 0) && !f.isWindow(e) &&
      ...
      if (!i.preDispatch || i.preDispatch.call(this, c) !== !1) {
        ...
        for (k = 0; k < j.length && !c.isPropagationStopped(); k++) {
          ...
          for (l = 0; l < q.matches.length && !c.isImmediatePropagationStopped(); l++) {
            s = q.matches[l];
            if (h || !c.namespace && !s.namespace || c.namespace_re && c.namespace_re.test(s.namespace)) c.data = s.data, c.handleObj = s, o = ((f.event.special[s.origType] || {}).handle || s.handler).apply(q.elem, g), o !== b &&
    ...
    mouseHooks: {
      props: 'button buttons clientX clientY fromElement offsetX offsetY pageX pageY screenX screenY toElement'.split(' '), filter: function(a, d) {
        ...
        (e = a.target.ownerDocument || c, f = e.documentElement, g = e.body, a.pageX = d.clientX + (f && f.scrollLeft || g && g.scrollLeft || 0) - (f && f.clientLeft || g && g.clientLeft || 0), a.pageY = d.clientY + (f && f.scrollTop || g && g.scrollTop || 0) -
            (f && f.clientTop || g && g.clientTop || 0)), !a.relatedTarget && i && (a.relatedTarget = i === a.target ? d.toElement : i), !a.which && h !== b && (a.which = h & 1 ? 1 : h & 2 ? 3 : h & 4 ? 2 : 0);
        return a;
      },
    },
    fix: function(a) {
    ...
    special: {
      ...
      beforeunload: {setup: function(a, b, c) {f.isWindow(this) && (this.onbeforeunload = c);}, teardown: function(a, b) {this.onbeforeunload === b && (this.onbeforeunload = null);}},
    },
    ...
    a && a.type ? (this.originalEvent = a, this.type = a.type, this.isDefaultPrevented = a.defaultPrevented || a.returnValue === !1 || a.getPreventDefault && a.getPreventDefault() ? K : J) : this.type = a, b && f.extend(this, b), this.timeStamp = a && a.timeStamp ||
    ...
    }, stopImmediatePropagation: function() {this.isImmediatePropagationStopped = K, this.stopPropagation();}, isDefaultPrevented: J, isPropagationStopped: J, isImmediatePropagationStopped: J,
    ...
    setup: function() {
      if (z.test(this.nodeName)) {
        if (this.type === 'checkbox' || this.type === 'radio') f.event.add(this, 'propertychange._change', function(a) {a.originalEvent.propertyName === 'checked' && (this._just_changed = !0);}), f.event.add(this, 'click._change',
            function(a) {this._just_changed && !a.isTrigger && (this._just_changed = !1, f.event.simulate('change', this, a, !0));});
        return !1;
      }
    ...
    var m = function(b, d, e, f) {
      ...
      k || (k = j), k || m.error(q || b);
      if (g.call(k) === '[object Array]') if (!u) e.push.apply(e, k); else if (d && d.nodeType === 1) for (t = 0; k[t] != null; t++) k[t] && (k[t] === !0 || k[t].nodeType === 1 && m.contains(d, k[t])) && e.push(j[t]); else for (t = 0; k[t] != null; t++) k[t] && k[t].nodeType ===
      1 && e.push(j[t]); else s(k, e);
    ...
    var n = m.getText = function(a) {
      ...
      filter: {
        ...
        ATTR: function(a, b) {
          ...
          return d == null ? f === '!=' : !f && m.attr ? d != null : f === '=' ? e === g : f === '*=' ? e.indexOf(g) >= 0 : f === '~=' ? (' ' + e + ' ').indexOf(g) >= 0 : g ? f === '!=' ? e !== g : f === '^=' ? e.indexOf(g) === 0 : f === '$='
    ...
    }(), c.documentElement.contains ? m.contains = function(a, b) {return a !== b && (a.contains ? a.contains(b) : !0);} : c.documentElement.compareDocumentPosition
  ...
  var V = 'abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video', W = / jQuery\d+="(?:\d+|null)"/g, X = /^\s+/,
      Y = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig, Z = /<([\w:]+)/, $ = /<tbody/i, _ = /<|&#?\w+;/, ba = /<(?:script|style)/i, bb = /<(?:script|object|embed|option|style)/i, bc = new RegExp('<(?:' + V + ')[\\s/>]', 'i'),
  ...
  bg.optgroup = bg.option, bg.tbody = bg.tfoot = bg.colgroup = bg.caption = bg.thead, bg.th = bg.td, f.support.htmlSerialize || (bg._default = [1, 'div<div>', '</div>']), f.fn.extend({
    ...
    var e, g, h, i, j = a[0];
    b && b[0] && (i = b[0].ownerDocument || b[0]), i.createDocumentFragment || (i = c), a.length === 1 && typeof j == 'string' && j.length < 512 && i === c && j.charAt(0) === '<' && !bb.test(j) && (f.support.checkClone || !bd.test(j)) && (f.support.html5Clone || !bc.test(j)) &&
    (g = !0, h = f.fragments[j], h && h !== 1 && (e = h)), e || (e = i.createDocumentFragment(), f.clean(a, i, e, d)), g && (f.fragments[j] = h ? e : 1);
  ...
  var bp = /alpha\([^)]*\)/i, bq = /opacity=([^)]*)/, br = /([A-Z]|^ms)/g, bs = /^[\-+]?(?:\d*\.)?\d+$/i, bt = /^-?(?:\d*\.)?\d+(?!px)[^\d\s]+$/i, bu = /^([\-+])=([\-+.\de]+)/, bv = /^margin/, bw = {position: 'absolute', visibility: 'hidden', display: 'block'},
  ...
  f.fn.css = function(a, c) {return f.access(this, function(a, c, d) {return d !== b ? f.style(a, c, d) : f.css(a, c);}, a, c, arguments.length > 1);}, f.extend({
    ...
    b = b.replace(br, '-$1').toLowerCase(), (d = a.ownerDocument.defaultView) && (e = d.getComputedStyle(a, null)) && (c = e.getPropertyValue(b), c === '' && !f.contains(a.ownerDocument.documentElement, a) && (c = f.style(a, b))), !f.support.pixelMargin && e && bv.test(b) &&
    bt.test(c) && (g = h.width, h.width = c, c = e.width, h.width = g);
    return c;
  }), c.documentElement.currentStyle && (bA = function(a, b) {
    var c, d, e, f = a.currentStyle && a.currentStyle[b], g = a.style;
    f == null && g && (e = g[b]) && (f = e), bt.test(f) && (c = g.left, d = a.runtimeStyle && a.runtimeStyle.left, d && (a.runtimeStyle.left = a.currentStyle.left), g.left = b === 'fontSize' ? '1em' : f, f = g.pixelLeft + 'px', g.left = c, d && (a.runtimeStyle.left = d));
    return f === '' ? 'auto' : f;
  }), by = bz || bA, f.each(['height', 'width'],
      function(a, b) {f.cssHooks[b] = {get: function(a, c, d) {if (c) return a.offsetWidth !== 0 ? bB(a, b, d) : f.swap(a, bw, function() {return bB(a, b, d);});}, set: function(a, b) {return bs.test(b) ? b + 'px' : b;}};}), f.support.opacity || (f.cssHooks.opacity = {
  ...
  }), f(function() {f.support.reliableMarginRight || (f.cssHooks.marginRight = {get: function(a, b) {return f.swap(a, {display: 'inline-block'}, function() {return b ? by(a, 'margin-right') : a.style.marginRight;});}});}), f.expr && f.expr.filters &&
  ...
  var bC = /%20/g, bD = /\[\]$/, bE = /\r?\n/g, bF = /#.*$/, bG = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg, bH = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
      bI = /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/, bJ = /^(?:GET|HEAD)$/, bK = /^\/\//, bL = /\?/, bM = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, bN = /^(?:select|textarea)/i, bO = /\s+/, bP = /([?&])_=[^&]*/,
    ...
    ajax: function(a, c) {
      function w(a, c, l, m) {
        if (s !== 2) {
          ...
          v.status = a, v.statusText = '' + (c || w), o ? h.resolveWith(e, [r, w, v]) : h.rejectWith(e, [v, w, u]), v.statusCode(j), j = b, t && g.trigger('ajax' + (o ? 'Success' : 'Error'), [v, d, o ? r : u]), i.fireWith(e, [v, w]), t &&
      ...
      h.promise(v), v.success = v.done, v.error = v.fail, v.complete = i.add, v.statusCode = function(a) {
        ...
        return this;
      }, d.url = ((a || d.url) + '').replace(bF, '').replace(bK, bV[1] + '//'), d.dataTypes = f.trim(d.dataType || '*').toLowerCase().split(bO), d.crossDomain == null &&
      (r = bQ.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] == bV[1] && r[2] == bV[2] && (r[3] || (r[1] === 'http:' ? 80 : 443)) == (bV[3] || (bV[1] === 'http:' ? 80 : 443)))), d.data && d.processData && typeof d.data != 'string' &&
      ...
      (k = k || d.url, f.lastModified[k] && v.setRequestHeader('If-Modified-Since', f.lastModified[k]), f.etag[k] && v.setRequestHeader('If-None-Match', f.etag[k])), v.setRequestHeader('Accept',
  ...
  f.ajaxSetup({jsonp: 'callback', jsonpCallback: function() {return f.expando + '_' + cc++;}}), f.ajaxPrefilter('json jsonp', function(b, c, d) {
    ...
    if (b.dataTypes[0] === 'jsonp' || b.jsonp !== !1 && (cd.test(b.url) || e && cd.test(b.data))) {
      ...
      b.jsonp !== !1 && (j = j.replace(cd, l), b.url === j && (e && (k = k.replace(cd, l)), b.data === k && (j += (/\?/.test(j) ? '&' : '?') + b.jsonp + '=' + h))), b.url = j, b.data = k, a[h] = function(a) {g = [a];}, d.always(
          function() {a[h] = i, g && f.isFunction(i) && a[h](g[0]);}), b.converters['script json'] = function() {
  ...
  f.fn.extend({
    show: function(a, b, c) {
      ...
      for (var g = 0, h = this.length; g < h; g++) d = this[g], d.style &&
      (e = d.style.display, !f._data(d, 'olddisplay') && e === 'none' && (e = d.style.display = ''), (e === '' && f.css(d, 'display') === 'none' || !f.contains(d.ownerDocument.documentElement, d)) && f._data(d, 'olddisplay', cu(d.nodeName)));
      for (g = 0; g < h; g++) {
        d = this[g];
        if (d.style) {
          e = d.style.display;
      ...
      function g() {
        ...
        for (g in a) {
          ...
          c && (g === 'height' || g === 'width') && (b.overflow = [this.style.overflow, this.style.overflowX, this.style.overflowY], f.css(this, 'display') === 'inline' && f.css(this, 'float') === 'none' &&
          (!f.support.inlineBlockNeedsLayout || cu(this.nodeName) === 'inline' ? this.style.display = 'inline-block' : this.style.zoom = 1));
        }
        b.overflow != null && (this.style.overflow = 'hidden');
        for (i in a) j = new f.fx(this, b, i), h = a[i], cm.test(h) ? (q = f._data(this, 'toggle' + i) || (h === 'toggle' ? d ? 'show' : 'hide' : 0), q ? (f._data(this, 'toggle' + i, q === 'show' ? 'hide' : 'show'), j[q]()) : j[h]()) : (m = cn.exec(h), n = j.cur(), m
            ? (o = parseFloat(m[2]), p = m[3] || (f.cssNumber[i] ? '' : 'px'), p !== 'px' && (f.style(this, i, (o || 1) + p), n = (o || 1) / j.cur() * n, f.style(this, i, n + p)), m[1] && (o = (m[1] === '-=' ? -1 : 1) * o + n), j.custom(n, o, p))
            : j.custom(n, h, ''));
        return !0;
      }
    ...
    speed: function(a, b, c) {
      ...
      return d;
    }, easing: {linear: function(a) {return a;}, swing: function(a) {return -Math.cos(a * Math.PI) / 2 + .5;}}, timers: [], fx: function(a, b, c) {this.options = b, this.elem = a, this.prop = c, b.orig = b.orig || {};},
  }), f.fx.prototype = {
  ...
  }), f.each(cp.concat.apply([], cp), function(a, b) {b.indexOf('margin') && (f.fx.step[b] = function(a) {f.style(a.elem, b, Math.max(0, a.now) + a.unit);});}), f.expr && f.expr.filters &&
  ...
  'getBoundingClientRect' in c.documentElement ? cv = function(a, b, c, d) {
    ...
    var g = b.body, h = cy(b), i = c.clientTop || g.clientTop || 0, j = c.clientLeft || g.clientLeft || 0, k = h.pageYOffset || f.support.boxModel && c.scrollTop || g.scrollTop, l = h.pageXOffset || f.support.boxModel && c.scrollLeft || g.scrollLeft, m = d.top + k - i,
        n = d.left + l - j;
    return {top: m, left: n};
  } : cv = function(a, b, c) {
    ...
    while ((a = a.parentNode) && a !== h && a !== c) {
      ...
      d = i ? i.getComputedStyle(a, null) : a.currentStyle, k -= a.scrollTop, l -= a.scrollLeft, a === e && (k += a.offsetTop, l += a.offsetLeft, f.support.doesNotAddBorder && (!f.support.doesAddBorderForTableAndCells || !cw.test(a.nodeName)) &&
      (k += parseFloat(d.borderTopWidth) || 0, l += parseFloat(d.borderLeftWidth) || 0), g = e, e = a.offsetParent), f.support.subtractsBorderForOverflowNotVisible && d.overflow !== 'visible' &&
    ...
    bodyOffset: function(a) {
      ...
      j ? (l = e.position(), m = l.top, n = l.left) : (m = parseFloat(h) || 0, n = parseFloat(i) || 0), f.isFunction(b) && (b = b.call(a, c, g)), b.top != null && (k.top = b.top - g.top + m), b.left != null && (k.left = b.left - g.left + n), 'using' in b
          ? b.using.call(a, k)
          : e.css(k);
    },
  }, f.fn.extend({
